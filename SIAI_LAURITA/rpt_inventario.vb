...
Public Class rpt_inventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIG_PT.rpt_inventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_familia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_inventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_inventario = New rpt_inventario
        rpt.Site = Me.Site
        Return rpt
    End Function
