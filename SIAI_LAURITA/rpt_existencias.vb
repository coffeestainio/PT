...
Public Class rpt_existencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIG_PT.rpt_existencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_existencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_existencias = New rpt_existencias
        rpt.Site = Me.Site
        Return rpt
    End Function
