...
Public Class rpt_venta_producto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIG_PT.rpt_venta_producto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_venta_producto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_venta_producto = New rpt_venta_producto
        rpt.Site = Me.Site
        Return rpt
    End Function
