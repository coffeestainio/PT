...
Public Class rpt_venta_neta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIG_PT.rpt_venta_neta.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_cliente() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_venta_neta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_venta_neta = New rpt_venta_neta
        rpt.Site = Me.Site
        Return rpt
    End Function
