...
Public Class rpt_notas_credito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIG_PT.rpt_notas_credito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_notas_credito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_notas_credito = New rpt_notas_credito
        rpt.Site = Me.Site
        Return rpt
    End Function
